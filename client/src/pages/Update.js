...
import { updateEmployee } from '../redux/actions/contentAction';
...
export class CustomizedSteppers extends Component {
    ...
    render() {
        const {classes,handleSubmit, reset,pristine, submitting, valid ,updateEmployee,errs,history,id} = this.props;
          ...
          </div>
          {
                  ...
                  <Button onClick={this.handleReset} variant="contained" className={classes.button}>
                    ...
                    <Button  variant="contained"
                      color="primary"
                      onClick={  handleSubmit(val => updateEmployee(val,reset,id))}
...
export default connect(mapStateToProps, {resetToken,updateEmployee})
